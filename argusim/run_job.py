...
def plot_results(job_directory):
    print(GREEN + "Plotting..." + RESET)
    process = subprocess.Popen(["python3", plot_script_abs, job_directory], cwd=os.path.dirname(plot_script_abs))
...
if __name__ == "__main__":
    ...
    trials_manager_process = subprocess.Popen(
        [
            "python3",
            "argusim/simulation_manager/run_trials.py",
            trial_command,
            trial_command_dir,
            job_directory_abs,
            parameter_file_abs,
    ...
    # ================================================= plot the data =================================================
    plot_results(job_directory_abs)
